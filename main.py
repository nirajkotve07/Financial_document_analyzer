...
def run_crew(query: str, file_path: str = "data/sample.pdf"):
    ...
    # We will pass the file_path directly to the task
    
    # Instantiate the agent with the dynamically created tool
    financial_analyst = financial_analyst_agent
    financial_analyst.tools = [FinancialDocumentTool(path=file_path)]
    
    # Instantiate the task with the dynamically created tool
    analyze_financial_document = analyze_financial_document_task
